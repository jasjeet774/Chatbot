...
function waitAndResponce(inputText) {
    ...
    if(inputText.toLowerCase().includes("my name is")){
        ...
        if(name.toLowerCase().includes("CHatbot")){
    ...
    switch (inputText.toLowerCase().trim()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>Chatbot</a>.</span><br><br>I am a here for your<span class='bold'> help👨🏻‍💻</span><br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        ...
        case "resume":
            ...
            break;
        case "skills":
            sendTextMessage("<span class='sk'>I am here for your help.<br><br>I can comfortably write code in following languages :<br><span class='bold'>Java<br>C<br>PHP<br>Kotlin<br>Dart<br><br>CSS<br>HTML<br>JavaScript</span><br><br>I am well versed with following frameworks :<span class='bold'><br>Android<br>Flutter<br>ReactJs</span><br>");
            break;
